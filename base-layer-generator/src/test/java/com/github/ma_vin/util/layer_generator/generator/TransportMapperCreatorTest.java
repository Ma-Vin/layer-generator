...
import com.github.ma_vin.util.layer_generator.generator.generator.TransportMapperCreator;
...
public class TransportMapperCreatorTest extends AbstractCreatorTest {
    ...
    private List<String> getDefaultExpected() {
        ...
        expected.add("");
        expected.add("import com.github.ma_vin.util.layer_generator.annotations.mapper.BaseTransportMapper;");
