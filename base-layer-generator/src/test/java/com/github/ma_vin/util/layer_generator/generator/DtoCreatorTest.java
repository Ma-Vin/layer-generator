...
import com.github.ma_vin.util.layer_generator.generator.generator.DtoCreator;
...
public class DtoCreatorTest extends AbstractCreatorTest {
    ...
    private List<String> getDefaultExpected() {
        ...
        expected.add("");
        expected.add("import com.github.ma_vin.util.layer_generator.annotations.model.BaseDto;");
    ...
    public void testCreateDataTransportObjectWithVersion() {
        ...
        basicExpected.add("");
        basicExpected.add("import com.github.ma_vin.util.layer_generator.annotations.model.BaseDto;");
