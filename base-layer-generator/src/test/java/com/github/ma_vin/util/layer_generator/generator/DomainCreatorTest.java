...
import com.github.ma_vin.util.layer_generator.generator.generator.DomainCreator;
...
public class DomainCreatorTest extends AbstractCreatorTest {
    ...
    private List<String> getDefaultExpected() {
        ...
        expected.add("");
        expected.add("import com.github.ma_vin.util.layer_generator.annotations.model.BaseDomain;");
