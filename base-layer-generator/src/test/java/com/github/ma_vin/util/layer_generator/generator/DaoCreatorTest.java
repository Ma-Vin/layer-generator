...
import com.github.ma_vin.util.layer_generator.generator.generator.DaoCreator;
...
public class DaoCreatorTest extends AbstractCreatorTest {
    ...
    private List<String> getDefaultExpected() {
        ...
        expected.add("");
        expected.add("import com.github.ma_vin.util.layer_generator.annotations.model.BaseDao;");
    ...
    public void testCreateDataAccessObjectRelationNotOwner() {
        ...
        expectedConnection.add("import com.github.ma_vin.util.layer_generator.annotations.model.BaseDao;");
