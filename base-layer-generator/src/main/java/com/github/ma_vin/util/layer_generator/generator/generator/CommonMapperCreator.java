...
public class CommonMapperCreator extends AbstractCreator {
    ...
    private void createAndAddConvertToMethod(Clazz mapperClass) {
        ...
        convertToMethod.addParameter(String.format(CLASS_TWO_GENERICS, Map.class.getSimpleName(), String.class.getSimpleName(), MAPPED_GENERIC), AbstractMapperCreator.MAPPED_OBJECTS_PARAMETER_TEXT);
    ...
    private void createAndAddConvertToMethodJavaDoc(Method convertToMethod) {
        ...
        javaDoc.addParams(AbstractMapperCreator.MAPPED_OBJECTS_PARAMETER_TEXT
