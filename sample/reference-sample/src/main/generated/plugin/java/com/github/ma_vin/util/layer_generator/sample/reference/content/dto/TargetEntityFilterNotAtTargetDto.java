...
/**
 * Generated dto class of TargetEntityFilterNotAtTarget
 */
@BaseDto("com.github.ma_vin.util.layer_generator.sample.reference.content.dto")
@Data
@NoArgsConstructor
@SuppressWarnings("java:S1068")
public class TargetEntityFilterNotAtTargetDto implements ITransportable {

	/**
	 * Identification of TargetEntityFilterNotAtTarget
	 */
